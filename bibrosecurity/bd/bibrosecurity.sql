...
START TRANSACTION;
USE `bibroSecurity`;
INSERT INTO `user` (`id`, `name`, `lastName`, `email`, `password`, `partner_id`, `active`) VALUES (1, 'Administrador', 'Administrador', 'admin@bibrosecurity.com', 'admin', 1, 1);
