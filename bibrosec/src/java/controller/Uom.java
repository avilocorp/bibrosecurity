...
@NamedQueries({
    ...
    @NamedQuery(name = "Uom.findByActive", query = "SELECT u FROM Uom u WHERE u.active = :active")})
public class Uom implements Serializable {
    ...
    public Uom(Integer id, String name, boolean active) {
        this.id = id;
        this.name = name;
        this.active = active;
    }
