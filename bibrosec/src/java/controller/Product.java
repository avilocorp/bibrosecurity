...
@NamedQueries({
    ...
    @NamedQuery(name = "Product.findByUomId", query = "SELECT p FROM Product p WHERE p.uomId = :uomId"),
...
public class Product implements Serializable {
    ...
    public Product(Integer id, String name, double purchasePrice, double salePrice, double qtyAvailable, double incomingQty, double virtualAvailable, int uomId, int categoryId, boolean active) {
        this.id = id;
        this.name = name;
