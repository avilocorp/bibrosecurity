...
@NamedQueries({
    ...
    @NamedQuery(name = "UserType.findByActive", query = "SELECT u FROM UserType u WHERE u.active = :active")})
public class UserType implements Serializable {
    ...
    public UserType(Integer id, String name, boolean active) {
        this.id = id;
        this.name = name;
        this.active = active;
    }
    ...
    public String toString() {
        return "controller.UserType[ id=" + id + " ]";
    }
